...
const MEETINGS = [
    {
        day: "2",
        month: "พ.ค.",
        title: "วภพ. จัดอบรม: การใช้เทคโนโลยี AI ในร้านยาแม่นยำ",
    ...
    },
    {
        day: "1",
        month: "มี.ค.",
        title: "ประชุมวิชาการ วภพ.: อนาคตเภสัชพันธุศาสตร์ในยุคดิจิทัล",
        location: "ห้อง Sapphire 204-206 ศูนย์การประชุม อิมแพ็ค ฟอรั่ม เมืองทองธานี จังหวัดนนทบุรี",
    ...
    },
    {
        day: "13",
        month: "ก.พ.",
        title: "เปิดรับสมัคร: หลักสูตรเภสัชพันธุศาสตร์คลินิก รุ่นที่ 5",
        location: "ห้อง Sapphire 204-206 ศูนย์การประชุม อิมแพ็ค ฟอรั่ม เมืองทองธานี จังหวัดนนทบุรี",
        dateRange: "วันที่จัดประชุม : 02 พ.ค. 2569 - 13 ก.ย. 2569",
        participants: (
